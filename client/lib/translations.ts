...
export const translations: Record<Language, Record<string, string>> = {
  ...
  zh: {
    ...
    missionStatement2:
      "由一家小型南非工程公司起步，EHL现已成为工程、采购和建设管理（EPCM）以及工程、采购和建设服务（EPC）领域的领导者。从概念到设计、调试和项目移交，售后维护和支持，EHL工程集团以提供量身定制的交钥匙解决方案而闻名。我们独特的端到端方法确保透明高效的项目管理，在整个价值链中提供安心保障。",
    servicesSubtitle:
      "EHL致力于为客户提供超越标准项目公司体验的服务。我们的重点是了解客户需求，同时建立强大的合作伙伴关系，确保我们的工程解决方案不仅设计安全，而且符合预算。",
    employeesLabel: "经验丰富的员工",
    decadesLabel: "工程卓越的数十年",
    projectsLabel: "已交付项目",
    happyClientsLabel: "满意客户",
    ltiManhoursLabel: "无工伤工时",
    ourStrategy: "我们的战略",
    consultStrategy: "咨询",
    consultStrategyDesc: "沟通是我们顾问了解客户需求和期望的关键。我们在任何设计开始前花时间真正了解您的项目。",
    designStrategy: "设计",
    designStrategyDesc: "创建世界级解决方案，不仅满足而且超越客户期望。我们的多学科设计团队利用BIM、ETAP、AutoCAD、Revit和DigSilent等最新工具。",
    constructStrategy: "建造",
    constructStrategyDesc: "我们的项目团队按时、在预算内并以最高安全和质量标准构建和交付所需成果。",
    ourResults: "我们的成果",
    designedSafeTag: "安全文化",
    designedSafe: "安全设计",
    designedSafeDesc: "在EHL，安全是不可妥协的。每一个行动，无论多么微小，都有助于我们整体的安全文化。2025年，EHL达到了350万无工伤工时的新里程碑——这是我们坚定承诺的见证。",
    howWeWork: "我们如何工作",
    whatWeDo: "我们的业务",
  ...
  fr: {
    ...
    missionStatement2:
      "Partis d'une petite société d'ingénierie sud-africaine, nous sommes devenus un leader dans la gestion de l'ingénierie, de l'approvisionnement et de la construction (EPCM), et des services EPC. Du concept à la conception, à la mise en service et à la remise du projet, en passant par la maintenance et le support après-vente, le Groupe EHL Engineering est reconnu pour livrer des solutions clé en main adaptées aux besoins de ses clients.",
    servicesSubtitle:
      "EHL cherche à offrir à ses clients plus qu'une simple expérience de bureau de projets standard. Notre objectif est de comprendre les besoins de nos clients tout en créant de solides partenariats afin que nos solutions d'ingénierie soient conçues en toute sécurité et dans le respect du budget.",
    employeesLabel: "Employés expérimentés",
    decadesLabel: "Décennies d'excellence en ingénierie",
    projectsLabel: "Projets livrés",
    happyClientsLabel: "Clients satisfaits",
    ltiManhoursLabel: "Heures-hommes sans accident",
    ourStrategy: "Notre stratégie",
    consultStrategy: "Consulter",
    consultStrategyDesc: "La communication est essentielle pour nos consultants expérimentés afin de comprendre les exigences et les attentes des clients. Nous prenons le temps de vraiment connaître votre projet avant que toute conception ne commence.",
    designStrategy: "Concevoir",
    designStrategyDesc: "Créer des solutions de classe mondiale pour non seulement répondre, mais dépasser les attentes des clients. Nos équipes de conception multidisciplinaires utilisent les derniers outils, notamment BIM, ETAP, AutoCAD, Revit et DigSilent.",
    constructStrategy: "Construire",
    constructStrategyDesc: "Nos équipes de projet construisent et livrent les résultats et la valeur nécessaires pour optimiser les opérations — à temps, dans les limites du budget et selon les normes de sécurité et de qualité les plus élevées.",
    ourResults: "Nos résultats",
    designedSafeTag: "Culture de la sécurité",
    designedSafe: "Conçu en sécurité",
    designedSafeDesc: "Chez EHL, la sécurité n'est pas négociable. Chaque action, aussi petite soit-elle, contribue à notre culture globale de la sécurité. En 2025, EHL a atteint un nouveau jalon de 3,5 millions d'heures-hommes sans accident.",
  ...
  de: {
    ...
    missionStatement2:
      "Aus einem kleinen südafrikanischen Ingenieurbüro ist ein Marktführer auf dem Gebiet der Ingenieur-, Beschaffungs- und Bauverwaltung (EPCM) sowie der Ingenieur-, Beschaffungs- und Bauleistungen (EPC) geworden. Von der Konzeption über Design, Inbetriebnahme und Projektübergabe bis hin zu Wartung und Support nach dem Service ist die EHL Engineering Group bekannt für die Lieferung von schlüsselfertigen Lösungen, die auf die Bedürfnisse unserer Kunden zugeschnitten sind.",
    servicesSubtitle:
      "EHL ist bestrebt, unseren Kunden mehr als nur eine Standard-Projekthauserfahrung zu bieten. Unser Fokus liegt darauf, die Bedürfnisse unserer Kunden zu verstehen und gleichzeitig starke Partnerschaften aufzubauen, damit unsere Ingenieurlösungen nicht nur sicher, sondern auch budgetgerecht gestaltet sind.",
    employeesLabel: "Erfahrene Mitarbeiter",
    decadesLabel: "Jahrzehnte der Ingenieurexzellenz",
    projectsLabel: "Gelieferte Projekte",
    happyClientsLabel: "Zufriedene Kunden",
    ltiManhoursLabel: "LTI-freie Mannstunden",
    ourStrategy: "Unsere Strategie",
    consultStrategy: "Beraten",
    consultStrategyDesc: "Kommunikation ist entscheidend für unsere erfahrenen Berater, um die Anforderungen und Erwartungen der Kunden zu verstehen. Wir nehmen uns die Zeit, Ihr Projekt wirklich zu kennen, bevor ein Design beginnt.",
    designStrategy: "Entwerfen",
    designStrategyDesc: "Weltklasse-Lösungen entwickeln, die Kundenerwartungen nicht nur erfüllen, sondern übertreffen. Unsere multidisziplinären Designteams nutzen die neuesten Tools, einschließlich BIM, ETAP, AutoCAD, Revit und DigSilent.",
    constructStrategy: "Bauen",
    constructStrategyDesc: "Unsere Projektteams bauen und liefern die Ergebnisse und den Wert, der zur Optimierung des Betriebs benötigt wird — pünktlich, im Budget und nach höchsten Sicherheits- und Qualitätsstandards.",
    ourResults: "Unsere Ergebnisse",
    designedSafeTag: "Sicherheitskultur",
    designedSafe: "Sicher entworfen",
    designedSafeDesc: "Bei EHL ist Sicherheit nicht verhandelbar. Jede Aktion, egal wie klein, trägt zu unserer gesamten Sicherheitskultur bei. Im Jahr 2025 erreichte EHL einen neuen Meilenstein von 3,5 Millionen LTI-freien Mannstunden.",
  ...
  es: {
    ...
    missionStatement2:
      "Lo que comenzó como una pequeña empresa de ingeniería sudafricana ahora es un líder en el campo de la gestión de ingeniería, adquisición y construcción (EPCM) y los servicios EPC. Desde el concepto hasta el diseño, la puesta en marcha y la entrega del proyecto, el mantenimiento y soporte posventa, el EHL Engineering Group es conocido por entregar soluciones llave en mano adaptadas a las necesidades de nuestros clientes.",
    servicesSubtitle:
      "EHL busca ofrecer a sus clientes más que una experiencia estándar de proyecto. Nuestro enfoque está en comprender las necesidades del cliente mientras creamos fuertes asociaciones para que nuestras soluciones de ingeniería no solo estén diseñadas de forma segura sino también dentro del presupuesto.",
    employeesLabel: "Empleados experimentados",
    decadesLabel: "Décadas de excelencia en ingeniería",
    projectsLabel: "Proyectos entregados",
    happyClientsLabel: "Clientes satisfechos",
    ltiManhoursLabel: "Horas-hombre libres de accidentes",
    ourStrategy: "Nuestra estrategia",
    consultStrategy: "Consultar",
    consultStrategyDesc: "La comunicación es clave para nuestros consultores experimentados con el fin de comprender los requisitos y expectativas del cliente. Nos tomamos el tiempo para conocer verdaderamente su proyecto antes de que comience cualquier diseño.",
    designStrategy: "Diseñar",
    designStrategyDesc: "Crear soluciones de clase mundial para no solo cumplir, sino superar las expectativas del cliente. Nuestros equipos de diseño multidisciplinarios aprovechan las últimas herramientas, incluyendo BIM, ETAP, AutoCAD, Revit y DigSilent.",
    constructStrategy: "Construir",
    constructStrategyDesc: "Nuestros equipos de proyecto construyen y entregan los resultados y el valor necesarios para optimizar las operaciones — a tiempo, dentro del presupuesto y con los más altos estándares de seguridad y calidad.",
    ourResults: "Nuestros resultados",
    designedSafeTag: "Cultura de seguridad",
    designedSafe: "Diseñado con seguridad",
    designedSafeDesc: "En EHL, la seguridad no es negociable. Cada acción, por pequeña que sea, contribuye a nuestra cultura de seguridad general. En 2025, EHL alcanzó un nuevo hito de 3,5 millones de horas-hombre sin accidentes.",
  ...
  ar: {
    ...
    missionStatement2:
      "ما بدأ كشركة هندسية صغيرة في جنوب أفريقيا، أصبح الآن رائدًا في مجال إدارة الهندسة والمشتريات والبناء (EPCM) وخدمات EPC. من المفهوم إلى التصميم والتشغيل وتسليم المشروع، تُعرف مجموعة EHL للهندسة بتقديم حلول متكاملة مصممة وفق احتياجات عملائنا.",
    servicesSubtitle:
      "تسعى EHL إلى تقديم ما يتجاوز تجربة بيت المشاريع القياسية لعملائها. ينصبّ تركيزنا على فهم احتياجات عملائنا مع إنشاء شراكات قوية حتى تكون حلولنا الهندسية مصممة بأمان وضمن الميزانية.",
    employeesLabel: "موظفون ذوو خبرة",
    decadesLabel: "عقود من التميز الهندسي",
    projectsLabel: "المشاريع المنجزة",
    happyClientsLabel: "عملاء راضون",
    ltiManhoursLabel: "ساعات عمل خالية من إصابات",
    ourStrategy: "استراتيجيتنا",
    consultStrategy: "الاستشارة",
    consultStrategyDesc: "التواصل هو المفتاح لمستشارينا ذوي الخبرة لفهم متطلبات العميل وتوقعاته. نأخذ الوقت الكافي لمعرفة مشروعك حقًا قبل بدء أي تصميم.",
    designStrategy: "التصميم",
    designStrategyDesc: "ابتكار حلول عالمية المستوى لتلبية توقعات العملاء بل وتجاوزها. تستخدم فرق التصميم متعددة التخصصات أحدث الأدوات بما فيها BIM وETAP وAutoCAD وRevit وDigSilent.",
    constructStrategy: "البناء",
    constructStrategyDesc: "تبني فرق مشاريعنا وتسلّم النتائج والقيمة اللازمة لتحسين العمليات — في الوقت المحدد وضمن الميزانية ووفق أعلى معايير السلامة والجودة.",
    ourResults: "نتائجنا",
    designedSafeTag: "ثقافة السلامة",
    designedSafe: "مصمّم بأمان",
    designedSafeDesc: "في EHL، السلامة أمر غير قابل للتفاوض. كل إجراء، مهما كان صغيرًا، يسهم في ثقافتنا العامة للسلامة. في عام 2025، وصلت EHL إلى معلم 3.5 مليون ساعة عمل خالية من إصابات.",
    howWeWork: "كيف نعمل",
    whatWeDo: "ما نقوم به",
  ...
  pt: {
    ...
    missionStatement2:
      "O que começou como uma pequena empresa de engenharia sul-africana é agora um líder no campo da gestão de engenharia, aquisição e construção (EPCM) e dos serviços EPC. Do conceito ao design, comissionamento e entrega do projeto, manutenção e suporte pós-serviço, o EHL Engineering Group é conhecido por entregar soluções turnkey personalizadas para as necessidades de nossos clientes.",
    servicesSubtitle:
      "A EHL procura oferecer aos seus clientes mais do que uma experiência padrão de escritório de projetos. O nosso foco está em compreender as necessidades dos nossos clientes enquanto criamos parcerias sólidas para que as nossas soluções de engenharia sejam projetadas com segurança e dentro do orçamento.",
    employeesLabel: "Funcionários experientes",
    decadesLabel: "Décadas de excelência em engenharia",
    projectsLabel: "Projetos entregues",
    happyClientsLabel: "Clientes satisfeitos",
    ltiManhoursLabel: "Horas-homem sem LTI",
    ourStrategy: "Nossa estratégia",
    consultStrategy: "Consultar",
    consultStrategyDesc: "A comunicação é fundamental para os nossos consultores experientes compreenderem os requisitos e expectativas dos clientes. Levamos o tempo necessário para realmente conhecer o seu projeto antes de qualquer design começar.",
    designStrategy: "Projetar",
    designStrategyDesc: "Criar soluções de classe mundial para não apenas atender, mas superar as expectativas dos clientes. Nossas equipes de design multidisciplinar aproveitam as ferramentas mais recentes, incluindo BIM, ETAP, AutoCAD, Revit e DigSilent.",
    constructStrategy: "Construir",
    constructStrategyDesc: "Nossas equipes de projeto constroem e entregam os resultados e o valor necessários para otimizar as operações — dentro do prazo, no orçamento e com os mais altos padrões de segurança e qualidade.",
    ourResults: "Nossos resultados",
    designedSafeTag: "Cultura de segurança",
    designedSafe: "Projetado com segurança",
    designedSafeDesc: "Na EHL, a segurança é inegociável. Cada ação, por menor que seja, contribui para a nossa cultura geral de segurança. Em 2025, a EHL atingiu um novo marco de 3,5 milhões de horas-homem sem LTI.",
  ...
  ru: {
    ...
    missionStatement2:
      "Начав как небольшая южноафриканская инженерная компания, мы стали лидером в области управления инжинирингом, закупками и строительством (EPCM) и услуг EPC. От концепции до проектирования, пуска и сдачи проекта, послепродажного обслуживания, EHL Engineering Group известна поставкой комплексных решений под ключ.",
    servicesSubtitle:
      "EHL стремится предложить своим клиентам больше, чем просто стандартный опыт проектного дома. Наш фокус — понимание потребностей клиентов и создание прочных партнёрств, чтобы наши решения были безопасными и укладывались в бюджет.",
    employeesLabel: "Опытные сотрудники",
    decadesLabel: "Десятилетия инженерного совершенства",
    projectsLabel: "Выполненных проектов",
    happyClientsLabel: "Довольных клиентов",
    ltiManhoursLabel: "Человеко-часов без травм",
    ourStrategy: "Наша стратегия",
    consultStrategy: "Консультировать",
    consultStrategyDesc: "Общение является ключевым для наших опытных консультантов для понимания требований и ожиданий клиента. Мы уделяем время, чтобы по-настоящему знать ваш проект до начала проектирования.",
    designStrategy: "Проектировать",
    designStrategyDesc: "Создавать решения мирового класса, чтобы не просто соответствовать, но и превзойти ожидания клиентов. Наши многопрофильные проектные группы используют новейшие инструменты, включая BIM, ETAP, AutoCAD, Revit и DigSilent.",
    constructStrategy: "Строить",
    constructStrategyDesc: "Наши проектные команды строят и доставляют необходимые результаты для оптимизации операций — вовремя, в рамках бюджета и с соблюдением высочайших стандартов безопасности и качества.",
    ourResults: "Наши результаты",
    designedSafeTag: "Культура безопасности",
    designedSafe: "Спроектировано безопасно",
    designedSafeDesc: "В EHL безопасность не подлежит обсуждению. Каждое действие, каким бы малым оно ни было, вносит вклад в нашу общую культуру безопасности. В 2025 году EHL достигла нового рубежа — 3,5 млн человеко-часов без травм.",
